...
Приветствуем Вас в вики Ultramarine! Этот ресурс был создан с целью познакомить вас с Ultramarine Linux.

Документация для разработчиков и ментейнеров пакетов была перемещена на [Fyra Developer](https://developer.fyralabs.com).

Если вы желаете внести вклад в проект, перейдите к [Секции о вкладе в проект(/ru/contributing/contributorguide).
...
Если же Вы желаете установить Ultramarine Linux, то тогда вам надо на секцию об [установке Ultramarine](/ru/setup/getting).

## Главная идея

Главная задача Ultramarine Linux - создать сразу используемую систему, не отставая от инноваций в нашей сфере. Чтобы её исполнить, мы придержуемся следующим принципам:
...
Мы считаем, что новые разработки в сфере Linux-систем положительно влияют на опыт и разработчиков, и обычных пользователей. Технологии вроде Flatpak и XDG Portals позволяют разработчикам создавать программы, работающие одинаково для всех. Разработки, независимые от нас, и наши личные разработки, например акцентные цвета и поддержка хромбуков, улучшают экосистему Linux. Все выигрывают.
